...
export function OrgLogin() {
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      <h1 className="text-2xl font-semibold text-slate-900">Organization sign in</h1>
      <p className="mt-2 text-sm text-slate-600">
        No account?{' '}
        <Link className="font-medium text-indigo-600 hover:text-indigo-500" to="/org/register">
      ...
      <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
        <div>
          <label className="block text-sm font-medium text-slate-700" htmlFor="org-username">
            Username
          </label>
          <input
            id="org-username"
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700" htmlFor="org-password">
            Password
          </label>
          <input
            id="org-password"
